	...
	<div class="header">
    	...
    	<div class="right_header">
            <div class="top_menu_privada">
            	<a href="index.php?controlador=LoginControlador&accion=mostrarFormulario" class="texto" ><?php MultiIdioma::gettexto("inicio.bienvenido") ?>: <?php echo $usuarioBean->getUsuario() ?></a>
			...
			<?php include HTML_ADMIN_PATH."/menu.php" ?>;
        </div>
    </div>
	<!--<div id="middle_box">
