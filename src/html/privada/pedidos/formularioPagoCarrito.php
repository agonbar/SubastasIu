...
<div id="contentBox">
    <ul>
        ...
        <li>-></li>
		<li><a class="submenu" href="index.php?controlador=ConsultarCarritoControlador&accion=consultarCarrito" ><?php MultiIdioma::gettexto("inicio.ver_carrito"); ?></a></li>
		 <li>-></li>
		<li><?php MultiIdioma::gettexto("realizarPago.titulo"); ?></li>
    </ul>
</div>
...
<?php
    foreach ($carritoBean->getListaComponentes() as $lineaPedido) {
?>
		<div class="box_text_content">
			...
			<div class="box_text_lineas">		
				<?php echo $lineaPedido->getVendedor()->getUsuario(); ?>
			</div>
...
?>
		<div class="box_text_content">
			<div class="box_text_lineas" id="total">
				<h3 >Total:<?php echo $carritoBean->getTotal() ?>&euro;</h3>
			</div>
		</div>
</div>
...
<div id="campo"><label><?php MultiIdioma::gettexto("realizarPago.codigo_postal") ?>:</label> <input type="text" name="cp" value="" /></div><br />
	...
	<input type="hidden" name="accion" value="realizarPagoCarrito" />
