...
<div id="contentBox">
    ...
    <ul>
        ...
        <li>|</li>
        <li><?php MultiIdioma::gettexto("menu.pedidos_recibidos"); ?></li>
    </ul>
</div>
</div>
</div>
<div class="box_content">
	...
	<form action="index.php">
		...
		<input type="hidden" name="listado" value="recibidos" />
			<table>
					<tr>
...
?>
		<div class="box_text_content">
			<div class="box_text_pedidos">
				<a href="index.php?controlador=ConsultarPedidoControlador&accion=consultarPedido&idPedido=<?php echo $pedido->getIdPedido() ?>" >
