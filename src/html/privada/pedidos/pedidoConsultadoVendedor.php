...
<div id="contentBox">
    <ul>
        ...
        <li>-></li>
		<li><a class="submenu" href="index.php?controlador=ListarPedidosControlador&accion=listarPedidosEnviados" ><?php MultiIdioma::gettexto("menu.pedidos_recibidos"); ?></a></li>
		<li>-></li>
		    ...
		    <div class="box_text_datos_per">	
		  	...
		  	<div class="box_text_datos_per">
		   		<select name="nuevoEstado">
					<option value="<?php echo ESTADO_PEDIDO_ACEPTADO ?>">Aceptado</option>
					<option value="<?php echo ESTADO_PEDIDO_RECHAZADO ?>">Rechazado</option>
				</select>
		    </div>
		    <div class="box_text_datos_per">
		    	<div class="right"><input type="submit" value="Cambiar estado" /></div>
		    </div>
		    <?php } ?>
		    <div class="box_text_ancho">
				<div class="right" ><a href="index.php?controlador=ListarPedidosControlador&accion=listarPedidosRecibidos" ><input type="button" value="<?php MultiIdioma::gettexto("comun.volver"); ?>" /></a></div>
			</div>
	</div>
