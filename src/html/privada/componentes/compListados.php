  	...
  	<div class="box_text_ancho">
		<div id="contentBox">
		    <ul>
		        <li><?php MultiIdioma::gettexto("menu.componentes"); ?></li>
		        <li>|</li>
		        <li><a class="submenu" href="index.php?controlador=ListarMisComponentesControlador&accion=listarComponentes" ><?php MultiIdioma::gettexto("menu.mis_componentes"); ?></a></li>
		        <li>|</li>
...
?>	
	<div class="box_text_content">
		...
		<div class="box_text_listar_comp">&nbsp;</div>
		<div class="box_text_listar_comp ult_campo">
			...
			<div class="right"><a href="index.php?controlador=ConsultarComponenteControlador&accion=consultarComponente&idComponente=<?php echo $componente->getIdComponente() ?>" class="details" >+ <?php MultiIdioma::gettexto("componentesListados.verDetalle"); ?></a></div>
		</div>
	</div>
	<div class="box_text_content">
