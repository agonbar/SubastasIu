...
<div id="contentBox">
    <ul>
        ...
        <li>-></li>
		<li><?php MultiIdioma::gettexto("menu.modificar_componente"); ?></li>
    </ul>
</div>
...
<input type="hidden" name="controlador" value="ModificarComponenteControlador" />
<input type="hidden" name="accion" value="modificarComponente" />
<input id="idCompSub" type="hidden" name="idComponente" value="<?php if (isset($_REQUEST["idComponente"])) { echo $_REQUEST["idComponente"]; } ?>" />
