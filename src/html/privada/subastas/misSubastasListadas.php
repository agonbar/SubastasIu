...
<div id="contentBox">
    <ul>
        ...
        <li>-></li>
		<li><?php MultiIdioma::gettexto("menu.mis_subastas"); ?></li>
    </ul>
</div>
...
<div class="box_content">
	<div class="box_title">
        ...
        <h2><?php MultiIdioma::gettexto("menu.mis_subastas"); ?></h2>
    </div>
	...
	<form action="index.php" >
	  <div class="box_text_content">
	  	<div class="box_text_ancho">
			...
			<input type="hidden" name="controlador" value="ListarMisSubastasControlador" />
