 ...
 */
class AltaComponenteControlador extends PrivadoControlador {
	...
	protected function ejecutar($accion) {
		switch($accion) {
			case "mostrarFormulario":
				...
				include (HTML_PRIVADA_COMPONENTES_PATH."/altaComponente.php");
				break;
			case "altaComponente":
				...
				try {
					...
					include (HTML_PRIVADA_COMPONENTES_PATH."/componenteCreado.php");
